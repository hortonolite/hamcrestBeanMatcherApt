package org.jresearch.hamcrest.beanmatcher.matcher.pecs;
...
public class IsIterableContaining<T> extends TypeSafeDiagnosingMatcher<Iterable<? extends T>> {
	 ...
	 *
	 * @param item
	 *                 the item to compare against the items provided by the
	 ...
	 *
	 * @param itemMatchers
	 *                         the matchers to apply to items provided by the
	 *                         examined {@link Iterable}
	 */
	@SafeVarargs
